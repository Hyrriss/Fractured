...
namespace Fractured.World
{
    ...
    public class Global
    {
        ...
        {
            StoryMarkers.Add(new StoryMarker(0, 0, StoryMarker.Time.Morning, StoryMarker.Mode.Story, "I should finish meeting my classmates before heading into the camp...", GetLocFromID(Loc_ID_Null), requiredCharacters: new Character[] { GetCharFromID(Char_ID_Karen), GetCharFromID(Char_ID_Mayu), GetCharFromID(Char_ID_Ayumu), GetCharFromID(Char_ID_Yori)}));
            StoryMarkers.Add(new StoryMarker(1, 0, StoryMarker.Time.Morning, StoryMarker.Mode.Story, "More classmates showed up, I should introduce myself before heading into camp...", GetLocFromID(Loc_ID_Entrance), requiredCharacters: new Character[] { GetCharFromID(Char_ID_Akihito), GetCharFromID(Char_ID_Michiko), GetCharFromID(Char_ID_Scarlet), GetCharFromID(Char_ID_Tomomi), GetCharFromID(Char_ID_Mina)}));
            StoryMarkers.Add(new StoryMarker(2, 0, StoryMarker.Time.Morning, StoryMarker.Mode.Story, "I should leave Tomomi to calming Mayu. In the meantime, I should finish introductions...", GetLocFromID(Loc_ID_Entrance), requiredCharacters: new Character[] { GetCharFromID(Char_ID_Hoshi), GetCharFromID(Char_ID_Katsuo), GetCharFromID(Char_ID_Airi), GetCharFromID(Char_ID_Shun)}));
            StoryMarkers.Add(new StoryMarker(3, 0, StoryMarker.Time.Morning, StoryMarker.Mode.Story, "I should make sure everyone's okay before leaving...", GetLocFromID(Loc_ID_Entrance), requiredCharacters: new Character[] { GetCharFromID(Char_ID_Michiko), GetCharFromID(Char_ID_Tomomi), GetCharFromID(Char_ID_Mina), GetCharFromID(Char_ID_Keshi)}));
            StoryMarkers.Add(new StoryMarker(4, 0, StoryMarker.Time.Day, StoryMarker.Mode.Story, "I need to head to the campfire so I don't get in trouble...", GetLocFromID(Loc_ID_Cafe), availableLocations: new Location[] { GetLocFromID(Loc_ID_Camp1), GetLocFromID(Loc_ID_Campfire)}));
